/**
 * Search twitter and process results.
 *
...
// For info on iterating search results see 
    ...
    search_ob.client.get('search/tweets', params, function(error, tweets, response) {
        ...
        if(search_ob.min_id !== null) {
            tweets.statuses = tweets.statuses.filter(function(tweet){
                return search_ob._leftpad(tweet.id_str, 20) !== search_ob.min_id;
            });
        }
        ...
        console.log(
            "request " + search_ob.request_count + ", result count: " 
        ...
        for(var i in tweets.statuses) {
            ...
            padded_id = search_ob._leftpad(tweets.statuses[i].id_str, 20);
